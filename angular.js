...
var githubSearch = angular.module('githubSearch', [
        'ngRoute',
        'ngResource',
        'MainCtrl',
        'Utils',
...
githubSearch.config(["$routeProvider", function($routeProvider){
    $routeProvider
        .when('/', {
            controller: 'MainCtrl'
        })
...
function($scope, $compile, Config, Github, Utils){
    ...
    $scope.searchuser = Config.searchuser;
    ...
    getResults();
    function getResults(){
        var searchRepos = GithubApi.searchAngularRepos($scope.searchuser, $scope.searchCategory);
  ...
  githubSearch.directive('myTruncate', [ function() {
  ...
  githubSearch.directive('onEnter',[ function() {
  ...
  githubSearch.filter('offset', function() {
...
githubSearch.factory('Github', ['$http', function($http){
